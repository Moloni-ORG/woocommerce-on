...
Moloni.OrdersBulkAction = (function(translations) {
    ...
    function BulkGenInvoice() {
        ...
        if (SelectedOrders && SelectedOrders.length === 0) {
            ProgressWindowMessage.html("<div>" + translations.noOrdersSelected + ProgressWindowCloseButton + "</div>");
        } else {
            ProgressWindowMessage.html(translations.startingProcess);
    ...
    function FinishBulkGenInvoice() {
        ...
        ProgressWindowMessage.append('<br>' + translations.documentsWithErrors + ' ' + FinalResultFailure.length);
    ...
    function FinishBulkDiscardOrder() {
        ...
        ProgressWindowMessage.append('<br>' + translations.ordersWithErrors + ' ' + FinalResultFailure.length);
        ProgressWindowMessage.append(ProgressWindowCloseButton);
    }
