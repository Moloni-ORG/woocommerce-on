...
use MoloniOn\Services\WcProduct\Interfaces\WcSyncInterface;
use MoloniOn\Services\WcProduct\Helpers\FetchImageFromMoloni;
use MoloniOn\Services\WcProduct\Helpers\FetchWcCategoriesFromMoloniCategoryId;
...
abstract class WcProductSyncAbstract implements WcSyncInterface
{
    ...
    protected function setImage()
    {
        ...
        if ($imageId > 0) {
            ...
            $imageMeta = get_post_meta($imageId, '_molonion_file_name', true);
