...
use MoloniOn\Services\Documents\SendDocumentMail;
...
class Documents
{
    ...
    public function createDocument(): Documents
    {
        ...
        apply_filters('moloni_on_after_insert_document', $this);
    ...
    {
        apply_filters('moloni_on_before_start_document', $this);
    ...
    private function saveLog(): void
    {
        ...
        $message = sprintf(__('%1$s was created with success (%2$s)', 'moloni-on'),
    ...
    {
        $this->order->add_meta_data('_molonion_sent', $this->documentId);
        $this->order->save();
    }
