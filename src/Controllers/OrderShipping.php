...
class OrderShipping
{
    ...
    private function setName(): OrderShipping
    {
        ...
        $this->name = apply_filters('moloni_on_after_order_shipping_setName', $name, $this->order);
    ...
    private function setSummary(?string $summary = ''): OrderShipping
    {
        ...
        $this->summary = apply_filters('moloni_on_after_order_shipping_setSummary', $summary, $this->order);
