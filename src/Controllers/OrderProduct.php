...
use MoloniOn\Controllers\Helpers\GetMoloniProductFromOrder;
...
class OrderProduct
{
    ...
    {
        $name = apply_filters('moloni_on_before_order_item_setName', $name, $this->orderProduct);

        if (empty($name)) {
            $name = $this->orderProduct->get_name();
        }

        $this->name = apply_filters('moloni_on_after_order_item_setName', $name, $this->orderProduct);
    ...
    {
        $summary = apply_filters('moloni_on_before_order_item_setSummary', $summary, $this->orderProduct);
        ...
        $this->summary = apply_filters('moloni_on_after_order_item_setSummary', $summary, $this->orderProduct);
