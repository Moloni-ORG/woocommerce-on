    ...
    <div>
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <select id="moloni_stock_sync" name='opt[moloni_stock_sync]' class='inputOut' <?= $canSyncStock ? '' : 'disabled="true"'; ?>>
            ...
            <tr>
                ...
                <td>
                    <select id="moloni_stock_sync_warehouse" name='opt[moloni_stock_sync_warehouse]' class='inputOut' <?= $warehouses ? '' : 'disabled="true"'; ?>>
                        <option value='0'>
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <select id="hook_product_sync" name='opt[hook_product_sync]' class='inputOut' <?= $hasWebhooks ? '' : 'disabled="true"'; ?>>
            ...
            <tr>
                ...
                <td>
                    <select id="hook_stock_sync" name='opt[hook_stock_sync]' class='inputOut' <?= $hasWebhooks && $canSyncStock ? '' : 'disabled="true"'; ?>>
            ...
            <tr>
                ...
                <td>
                    <select id="hook_stock_sync_warehouse" name='opt[hook_stock_sync_warehouse]' class='inputOut' <?= $warehouses ? '' : 'disabled="true"'; ?>>
                        <option value='1'>
