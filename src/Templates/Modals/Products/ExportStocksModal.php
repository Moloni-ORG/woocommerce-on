<div id="export-stocks-modal" class="modal" style="display: none">
    ...
    <div>
        <p>
            <?php esc_html_e('This tool will cycle for all your WooCommerce products and will insert manual stock movements in your Moloni account to make sure the stocks are equal in both platforms.', 'moloni-on') ?>
        </p>
        <p>
            <?php esc_html_e('When the tool is finish, all your Moloni stock will be updated to match the stock on your WooCommerce store.', 'moloni-on') ?>
        </p>
        <p>
