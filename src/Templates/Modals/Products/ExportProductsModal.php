<div id="export-products-modal" class="modal" style="display: none">
    <h2>
        <?php esc_html_e('Export products to Moloni', 'moloni-on') ?>
    </h2>
    <div>
        <p>
            <?php esc_html_e('This will fetch all the products in WooCommerce store and create them in your Moloni account.', 'moloni-on') ?>
        </p>
        <p>
