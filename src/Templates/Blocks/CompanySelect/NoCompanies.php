...
<div class="companies-invalid">
    ...
    <div class="companies-invalid__title">
        <?= __('You do not have any valid company to use the plugin', 'moloni_on') ?>
    </div>

    <div class="companies-invalid__message">
        <?= __('Please confirm that your account has access to an active company with a plan that allows you to access the plugins.', 'moloni_on') ?>
    </div>

    <div class="companies-invalid__help">
        <?= __('Learn more about our plans at: ', 'moloni_on') ?>
