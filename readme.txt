...
For any doubts or suggestions you can contact us via email suporte@moloni.pt.
...
Once you have such a plugin installed, select in the Moloni plugin settings which `custom_field` corresponds to the customer's taxpayer/VAT number.

== Installation ==
This plugin can be installed via FTP or using the WordPress plugin installer.

= Via FTP =
1. Upload the plugin files to `/wp-content/plugins/moloni-on` directory
...
== Upgrade Notice ==
= 3.0.00 =
 Released plugin version 3.0.0.

== Changelog ==
= 3.0.00 =
* Realized the plugin version 3.0.0.
