...
Once you have a plugin for the contributor installed, select in the settings of the Moloni plugin which `custom_field` corresponds to the client's contributor.
...
Via FTP
1. Upload the plugin files to `/wp-content/plugins/moloni_es` directory
...
2. All our settings available for plugin
